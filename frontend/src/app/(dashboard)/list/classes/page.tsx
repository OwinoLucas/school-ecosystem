  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const [classesData, classesCount] = await mockDataService.$transaction([
          mockDataService.classes.findMany({
            where: query,
            include: {
              supervisor: true,
            },
          ...
          mockDataService.classes.count({ where: query }),
        ]);
        
        setData(classesData);
        setCount(classesCount);
      } catch (error) {
